...
fullcalc02_off = load("fullcalc02_offresonance_2.mat");
fullcalc22_off = load("fullcalc22_offresonance_2.mat");
fullcalc24_off = load("fullcalc24_offresonance_2.mat");
...
fullcalc02_on = load("fullcalc02_onresonance_3.mat");
fullcalc22_on = load("fullcalc22_onresonance_3.mat");
fullcalc24_on = load("fullcalc24_onresonance_3.mat");
...
loglog(born22.energies2, born22.temparr, ":", LineWidth = 2)
loglog(born24.energies2, born24.temparr, ":", LineWidth = 2)
loglog(fullcalc02_on.energies, fullcalc02_on.temp_arr, "-", LineWidth = 2)
