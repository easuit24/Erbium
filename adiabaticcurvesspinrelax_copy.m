...
% hold on;
% for i = 1:numfun
%     % Plotting adiabatic curves
%     plot(r_plot, adiabatic_potentials(i, :), 'LineWidth', 1.5);
% end
% hold off;
% yline(energy, '--k', 'Total Collision Energy', 'LineWidth', 1.5, 'LabelHorizontalAlignment', 'left');
% % Formatting the plot
% set(gca, 'XScale', 'log'); % Log scale for r helps visualize both short/long range
