...
dBField = 0.1;
BFieldlo = 6.0; % originally 1 when reopened on 12/19
BFieldhi = 8.0; % orignally 50 when reopened on 12/19
%BFieldhi = .0;
...
energy = 1e-15/t0; % this is in SI units - so no need to convert later 
