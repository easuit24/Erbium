...
for iEn = 1:length(energies)
    ...
    T_mat_sr02(iEn) = -pi*dipole_conversion*renorm*coef*C02*radIntegral(0,2, ki_arr(iEn), kp); 
    
    T_mat_sr22(iEn) = -pi*dipole_conversion*renorm*coef*C22*radIntegral(2,2, ki_arr(iEn), kp); 
    T_mat_sr24(iEn) = -pi*dipole_conversion*renorm*coef*C24*radIntegral(2,4, ki_arr(iEn), kp); 
...
% fixed this function! (4/27) Havent tried it yet... 
