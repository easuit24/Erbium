% This file iterates over magnetic fields for a given collision energy to
% determine the relationship between the Born approximation and the
% numerics as a function of magnetic field 
clear all 
load_Er2
...
energy = 3.0e-13; % indcident collision energy 
%energy = 1e-9/t0; 
%energy = 1e-6/t0; 
for iBF = 1:numBF
    fprintf('Calculating BField %d of %d...\n', iBF, numBF);
    ...
    for f = 1:numopen
        ...
        if is_elastic_channel && m1_final_target == m1_incident && m2_final_target == m2_incident
            ...
            if Lmatindex <= maxLstorage
                T_matrix_numeric(iBF, Lmatindex) = ...
                    T_matrix_numeric(iBF, Lmatindex) + T_sq;
            end
